...
export const AboutUs = () => {
    ...
    return(
        ...
        <h3 className="text-center pb-2">Conócenos</h3>
            ...
            <p>
            También se les ofrece Atención Primaria, Médica, Habilitadora, Social, Psicológica, Hidroterapia, Ocio y Tiempo Libre, Comedor, Transporte, Respiro Familiar y Deporte Adaptado.
            </p>
            <p>
            El horario del Centro de Estancia Diurna con Terapia Ocupacional es de lunes a viernes, de 9:00 a 17:00 horas, también con recogida y desplazamiento al centro en transporte adaptado dentro del horario.
            </p>
